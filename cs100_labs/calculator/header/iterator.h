...
operations in iterator.cpp because 

"error: invalid use of incomplete type ‘class Base’"

ALSO  ??

iterator.cpp: In member function ‘virtual void PreOrderIterator::next()’:
iterator.cpp:85:16: warning: deleting object of abstract class type ‘Iterator’ which has non-virtual destructor will cause undefined behaviour [-Wdelete-non-virtual-dtor]
         delete temp;
